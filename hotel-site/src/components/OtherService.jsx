    ...
    <div className="pb-5 mt-6">
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-6 p-3 mt-5">
        ...
        <div className="w-full">
          <h1 className="text-black lg:text-4xl md:text-4xl xl:text-4xl text-2xl font-serif mb-4 md:text-center lg:text-start ">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 xl:grid-cols-2 gap-3 mt-5 p-2">
            ...
            <div className="flex gap-1 text-black">
              <span className="text-yellow-600 text-xl p-2">
                <FaCarAlt />
              </span>
              <div>
            ...
            <div className="flex gap-1 text-black">
              ...
              <div>
                ...
                <span className="block font-normal">
                  Stay seamlessly connected with our high-speed Wifi & Internet
                  services.
                </span>
              </div>
            </div>
            <div className="flex gap-1 text-black">
              ...
              <div>
                ...
                <span className="block font-normal">
                  Immerse yourself in the beauty of our surroundings with a
            ...
            <div className="flex gap-1 text-black">
              ...
              <div>
                ...
                <span className="block font-normal">
                  Unwind in style with our Cinema & Entertainment options. Enjoy
                  a cozy night in with a selection of the latest movies or live
                  streaming services.
                </span>
              </div>
            </div>
              ...
              <>
                <div className="flex gap-1 text-black">
                  ...
                  <div>
                    ...
                    <span className="block font-normal">
                      Experience the luxury of personalized care with our
                      meticulous Housekeeper Services.
                    </span>
                  </div>
                </div>
                <div className="flex gap-1 text-black">
                  ...
                  <div>
                    ...
                    <span className="block font-normal">
                      Travel light and worry-free with our convenient Laundry
                      Services.
                    </span>
                  </div>
                </div>
                <div className="flex gap-1 text-black">
                  ...
                  <div>
                    ...
                    <span className="block font-normal">
                      Start your day in the lap of luxury with our Breakfast in
                      Bed service.
                    </span>
                  </div>
                </div>
                <div className="flex gap-1 text-black">
                  ...
                  <div>
                    ...
                    <span className="block font-normal">
                      Your well-being is our priority, and with our Doctor on
                      Call service, you can rest assured knowing that medical
          ...
          {showAllItems ? (
            <button
              className="text-black text-md bg-yellow-600 rounded-lg font-bold mt-4 p-3 flex justify-center items-center mx-auto sm:block lg:hidden md:block"
            ...
            <button
              className=" w-50  text-black text-md bg-yellow-600 rounded-lg font-bold mt-4 p-3 flex  justify-center items-center mx-auto sm:block lg:hidden md:block "
              onClick={() => setShowAllItems(true)}
            >
              See More <span className="text-center" ><IoMdArrowDropdown /></span>
